// Generated code for Python source for module 'pip._vendor.requests.packages.urllib3.util.request'
...
// The _module_pip$_vendor$requests$packages$urllib3$util$request is a Python object pointer of module type.

// Note: For full compatibility with CPython, every module variable access
// needs to go through it except for cases where the module cannot possibly
// have changed in the mean time.

PyObject *module_pip$_vendor$requests$packages$urllib3$util$request;
PyDictObject *moduledict_pip$_vendor$requests$packages$urllib3$util$request;
...
extern PyObject *const_str_plain_accept_encoding;
static PyObject *const_str_digest_03534b46746053fb201ee32e58473667;
...
static PyObject *const_str_digest_d812678081bc2f60339bb926452dead9;
...
{
    const_str_digest_03534b46746053fb201ee32e58473667 = UNSTREAM_STRING( &constant_bin[ 483185 ], 86, 0 );
    const_str_digest_d812678081bc2f60339bb926452dead9 = UNSTREAM_STRING( &constant_bin[ 483271 ], 50, 0 );

    constants_created = true;
}

#ifndef __NUITKA_NO_ASSERT__
void checkModuleConstants_pip$_vendor$requests$packages$urllib3$util$request( void )
{
...
static PyCodeObject *codeobj_8e949e33f2e1ae102ac92dc4ddca6601;
static PyCodeObject *codeobj_58fd7176eba1588603af46838ff054b2;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_03534b46746053fb201ee32e58473667;
    codeobj_8e949e33f2e1ae102ac92dc4ddca6601 = MAKE_CODEOBJ( module_filename_obj, const_str_plain_make_headers, 9, const_tuple_bf13d4977692576812fdd050c4821ab2_tuple, 6, 0, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE );
    codeobj_58fd7176eba1588603af46838ff054b2 = MAKE_CODEOBJ( module_filename_obj, const_str_plain_request, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}

// The module function declarations.
static PyObject *MAKE_FUNCTION_function_1_make_headers_of_pip$_vendor$requests$packages$urllib3$util$request( PyObject *defaults );


// The module function definitions.
static PyObject *impl_function_1_make_headers_of_pip$_vendor$requests$packages$urllib3$util$request( Nuitka_FunctionObject const *self, PyObject **python_pars )
{
    ...
    // Tried code:
    MAKE_OR_REUSE_FRAME( cache_frame_function, codeobj_8e949e33f2e1ae102ac92dc4ddca6601, module_pip$_vendor$requests$packages$urllib3$util$request );
    ...
    goto branch_end_3;
    branch_no_3:;
    tmp_assign_source_3 = GET_STRING_DICT_VALUE( moduledict_pip$_vendor$requests$packages$urllib3$util$request, (Nuitka_StringObject *)const_str_plain_ACCEPT_ENCODING );
    ...
    tmp_called_name_3 = GET_STRING_DICT_VALUE( moduledict_pip$_vendor$requests$packages$urllib3$util$request, (Nuitka_StringObject *)const_str_plain_b64encode );
    ...
    tmp_called_name_4 = GET_STRING_DICT_VALUE( moduledict_pip$_vendor$requests$packages$urllib3$util$request, (Nuitka_StringObject *)const_str_plain_b );
    ...
    tmp_called_name_6 = GET_STRING_DICT_VALUE( moduledict_pip$_vendor$requests$packages$urllib3$util$request, (Nuitka_StringObject *)const_str_plain_b64encode );
    ...
    tmp_called_name_7 = GET_STRING_DICT_VALUE( moduledict_pip$_vendor$requests$packages$urllib3$util$request, (Nuitka_StringObject *)const_str_plain_b );
    ...
    NUITKA_CANNOT_GET_HERE( function_1_make_headers_of_pip$_vendor$requests$packages$urllib3$util$request );
    return NULL;
    // Return handler code:
...
static PyObject *MAKE_FUNCTION_function_1_make_headers_of_pip$_vendor$requests$packages$urllib3$util$request( PyObject *defaults )
{
    PyObject *result = Nuitka_Function_New(
        impl_function_1_make_headers_of_pip$_vendor$requests$packages$urllib3$util$request,
        const_str_plain_make_headers,
#if PYTHON_VERSION >= 330
        NULL,
#endif
        codeobj_8e949e33f2e1ae102ac92dc4ddca6601,
        defaults,
#if PYTHON_VERSION >= 300
        NULL,
        const_dict_empty,
#endif
        module_pip$_vendor$requests$packages$urllib3$util$request,
...
#if PYTHON_VERSION >= 300
static struct PyModuleDef mdef_pip$_vendor$requests$packages$urllib3$util$request =
{
    PyModuleDef_HEAD_INIT,
    "pip._vendor.requests.packages.urllib3.util.request",   /* m_name */
    NULL,                /* m_doc */
    -1,                  /* m_size */
    NULL,                /* m_methods */
    NULL,                /* m_reload */
...
MOD_INIT_DECL( pip$_vendor$requests$packages$urllib3$util$request )
{
    ...
    if ( _init_done )
    {
        return MOD_RETURN_VALUE( module_pip$_vendor$requests$packages$urllib3$util$request );
    }
    else
    {
        _init_done = true;
    ...
    // puts( "in initpip$_vendor$requests$packages$urllib3$util$request" );
    ...
    // use for it.
#if PYTHON_VERSION < 300
    module_pip$_vendor$requests$packages$urllib3$util$request = Py_InitModule4(
        "pip._vendor.requests.packages.urllib3.util.request",       // Module Name
...
#else
    module_pip$_vendor$requests$packages$urllib3$util$request = PyModule_Create( &mdef_pip$_vendor$requests$packages$urllib3$util$request );
#endif

    moduledict_pip$_vendor$requests$packages$urllib3$util$request = (PyDictObject *)((PyModuleObject *)module_pip$_vendor$requests$packages$urllib3$util$request)->md_dict;

    CHECK_OBJECT( module_pip$_vendor$requests$packages$urllib3$util$request );

// Seems to work for Python2.7 out of the box, but for Python3, the module
// doesn't automatically enter "sys.modules", so do it manually.
#if PYTHON_VERSION >= 300
    {
        int r = PyObject_SetItem( PySys_GetObject( (char *)"modules" ), const_str_digest_d812678081bc2f60339bb926452dead9, module_pip$_vendor$requests$packages$urllib3$util$request );
    ...
    PyObject *module_dict = PyModule_GetDict( module_pip$_vendor$requests$packages$urllib3$util$request );
    ...
    UPDATE_STRING_DICT0( moduledict_pip$_vendor$requests$packages$urllib3$util$request, (Nuitka_StringObject *)const_str_plain___doc__, tmp_assign_source_1 );
    tmp_assign_source_2 = const_str_digest_03534b46746053fb201ee32e58473667;
    UPDATE_STRING_DICT0( moduledict_pip$_vendor$requests$packages$urllib3$util$request, (Nuitka_StringObject *)const_str_plain___file__, tmp_assign_source_2 );
    tmp_assign_source_3 = Py_None;
    UPDATE_STRING_DICT0( moduledict_pip$_vendor$requests$packages$urllib3$util$request, (Nuitka_StringObject *)const_str_plain___cached__, tmp_assign_source_3 );
    tmp_assign_source_4 = const_str_digest_88f59c54076602dcb96ff841f9705fcc;
    UPDATE_STRING_DICT0( moduledict_pip$_vendor$requests$packages$urllib3$util$request, (Nuitka_StringObject *)const_str_plain___package__, tmp_assign_source_4 );
    tmp_assign_source_5 = PyObject_GetAttrString(PyImport_ImportModule("__future__"), "absolute_import");
    UPDATE_STRING_DICT0( moduledict_pip$_vendor$requests$packages$urllib3$util$request, (Nuitka_StringObject *)const_str_plain_absolute_import, tmp_assign_source_5 );
    // Frame without reuse.
    frame_module = MAKE_MODULE_FRAME( codeobj_58fd7176eba1588603af46838ff054b2, module_pip$_vendor$requests$packages$urllib3$util$request );
    ...
    // Framed code:
    tmp_import_globals_1 = ((PyModuleObject *)module_pip$_vendor$requests$packages$urllib3$util$request)->md_dict;
    ...
    UPDATE_STRING_DICT1( moduledict_pip$_vendor$requests$packages$urllib3$util$request, (Nuitka_StringObject *)const_str_plain_b64encode, tmp_assign_source_6 );
    tmp_import_globals_2 = ((PyModuleObject *)module_pip$_vendor$requests$packages$urllib3$util$request)->md_dict;
    ...
    UPDATE_STRING_DICT1( moduledict_pip$_vendor$requests$packages$urllib3$util$request, (Nuitka_StringObject *)const_str_plain_b, tmp_assign_source_7 );
    ...
    UPDATE_STRING_DICT0( moduledict_pip$_vendor$requests$packages$urllib3$util$request, (Nuitka_StringObject *)const_str_plain_ACCEPT_ENCODING, tmp_assign_source_8 );
    tmp_defaults_1 = const_tuple_none_none_none_none_none_none_tuple;
    tmp_assign_source_9 = MAKE_FUNCTION_function_1_make_headers_of_pip$_vendor$requests$packages$urllib3$util$request( INCREASE_REFCOUNT( tmp_defaults_1 ) );
    UPDATE_STRING_DICT1( moduledict_pip$_vendor$requests$packages$urllib3$util$request, (Nuitka_StringObject *)const_str_plain_make_headers, tmp_assign_source_9 );
