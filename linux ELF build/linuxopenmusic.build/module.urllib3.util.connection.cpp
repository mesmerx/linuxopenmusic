...
static PyObject *const_str_digest_e3950db8186be59462f7236c420b872d;
...
{
    const_str_digest_e3950db8186be59462f7236c420b872d = UNSTREAM_STRING( &constant_bin[ 717666 ], 59, 0 );
    const_str_digest_e055b71b959d7386600233cd6fd5936b = UNSTREAM_STRING( &constant_bin[ 184251 ], 23, 0 );
...
static PyCodeObject *codeobj_5bd0cc981834295664841e4c9e58f1ed;
static PyCodeObject *codeobj_96074cf9034703e42da64ce351d3af5e;
static PyCodeObject *codeobj_39063a70765fc320d58f372995cd69f1;
static PyCodeObject *codeobj_705c82823f1a2089cbf0c5a2bd869e22;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_e3950db8186be59462f7236c420b872d;
    codeobj_5bd0cc981834295664841e4c9e58f1ed = MAKE_CODEOBJ( module_filename_obj, const_str_plain__set_socket_options, 96, const_tuple_str_plain_sock_str_plain_options_str_plain_opt_tuple, 2, 0, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE );
    codeobj_96074cf9034703e42da64ce351d3af5e = MAKE_CODEOBJ( module_filename_obj, const_str_plain_connection, 1, const_tuple_empty, 0, 0, CO_NOFREE );
    codeobj_39063a70765fc320d58f372995cd69f1 = MAKE_CODEOBJ( module_filename_obj, const_str_plain_create_connection, 49, const_tuple_27e070f1b0707793aa69cd5f44b664e9_tuple, 4, 0, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE );
    codeobj_705c82823f1a2089cbf0c5a2bd869e22 = MAKE_CODEOBJ( module_filename_obj, const_str_plain_is_connection_dropped, 13, const_tuple_5110ff056a47bb5a3c4923457afa101e_tuple, 1, 0, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE );
}
...
static PyObject *MAKE_FUNCTION_function_1_is_connection_dropped_of_urllib3$util$connection(  );


static PyObject *MAKE_FUNCTION_function_2_create_connection_of_urllib3$util$connection( PyObject *defaults );


static PyObject *MAKE_FUNCTION_function_3__set_socket_options_of_urllib3$util$connection(  );


// The module function definitions.
static PyObject *impl_function_1_is_connection_dropped_of_urllib3$util$connection( Nuitka_FunctionObject const *self, PyObject **python_pars )
{
    ...
    // Tried code:
    MAKE_OR_REUSE_FRAME( cache_frame_function, codeobj_705c82823f1a2089cbf0c5a2bd869e22, module_urllib3$util$connection );
    ...
    goto frame_return_exit_1;
    branch_no_2:;
    tmp_cond_value_1 = GET_STRING_DICT_VALUE( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain_poll );
    ...
    branch_yes_3:;
    tmp_cond_value_2 = GET_STRING_DICT_VALUE( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain_select );
    ...
    branch_no_4:;
    // Tried code:
    tmp_called_name_1 = GET_STRING_DICT_VALUE( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain_select );
    ...
    NUITKA_CANNOT_GET_HERE( function_1_is_connection_dropped_of_urllib3$util$connection );
    return NULL;
    ...
    // End of try:
    branch_no_3:;
    tmp_called_name_2 = GET_STRING_DICT_VALUE( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain_poll );
    ...
    tmp_args_element_name_6 = GET_STRING_DICT_VALUE( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain_POLLIN );
...
static PyObject *impl_function_2_create_connection_of_urllib3$util$connection( Nuitka_FunctionObject const *self, PyObject **python_pars )
{
    // Preserve error status for checks
#ifndef __NUITKA_NO_ASSERT__
    NUITKA_MAY_BE_UNUSED bool had_error = ERROR_OCCURRED();
    ...
    // Actual function code.
    // Tried code:
    MAKE_OR_REUSE_FRAME( cache_frame_function, codeobj_39063a70765fc320d58f372995cd69f1, module_urllib3$util$connection );
    frame_function = cache_frame_function;
    ...
    // Tried code:
    tmp_source_name_5 = GET_STRING_DICT_VALUE( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain_socket );
    ...
    tmp_called_name_5 = GET_STRING_DICT_VALUE( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain__set_socket_options );
    ...
    tmp_source_name_6 = GET_STRING_DICT_VALUE( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain_socket );
    ...
    goto try_return_handler_3;
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( function_2_create_connection_of_urllib3$util$connection );
    return NULL;
    // Exception handler code:
    try_except_handler_5:;
    exception_keeper_type_3 = exception_type;
    ...
    tmp_source_name_10 = GET_STRING_DICT_VALUE( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain_socket );
    ...
    goto frame_exception_exit_1;
    branch_no_6:;
    tmp_source_name_12 = GET_STRING_DICT_VALUE( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain_socket );
...
static PyObject *impl_function_3__set_socket_options_of_urllib3$util$connection( Nuitka_FunctionObject const *self, PyObject **python_pars )
{
    // Preserve error status for checks
#ifndef __NUITKA_NO_ASSERT__
    NUITKA_MAY_BE_UNUSED bool had_error = ERROR_OCCURRED();
    ...
    goto try_return_handler_1;
    branch_no_1:;
    MAKE_OR_REUSE_FRAME( cache_frame_function, codeobj_5bd0cc981834295664841e4c9e58f1ed, module_urllib3$util$connection );
    frame_function = cache_frame_function;
    ...
    goto try_return_handler_1;
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( function_3__set_socket_options_of_urllib3$util$connection );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
...
static PyObject *MAKE_FUNCTION_function_1_is_connection_dropped_of_urllib3$util$connection(  )
{
    PyObject *result = Nuitka_Function_New(
        impl_function_1_is_connection_dropped_of_urllib3$util$connection,
        const_str_plain_is_connection_dropped,
#if PYTHON_VERSION >= 330
        NULL,
#endif
        codeobj_705c82823f1a2089cbf0c5a2bd869e22,
        NULL,
#if PYTHON_VERSION >= 300
        NULL,
        const_dict_empty,
...
{
    PyObject *result = Nuitka_Function_New(
        impl_function_2_create_connection_of_urllib3$util$connection,
        const_str_plain_create_connection,
#if PYTHON_VERSION >= 330
        NULL,
#endif
        codeobj_39063a70765fc320d58f372995cd69f1,
        defaults,
#if PYTHON_VERSION >= 300
        NULL,
        const_dict_empty,
...
{
    PyObject *result = Nuitka_Function_New(
        impl_function_3__set_socket_options_of_urllib3$util$connection,
        const_str_plain__set_socket_options,
#if PYTHON_VERSION >= 330
        NULL,
#endif
        codeobj_5bd0cc981834295664841e4c9e58f1ed,
        NULL,
#if PYTHON_VERSION >= 300
        NULL,
        const_dict_empty,
...
MOD_INIT_DECL( urllib3$util$connection )
{
    ...
    moduledict_urllib3$util$connection = (PyDictObject *)((PyModuleObject *)module_urllib3$util$connection)->md_dict;
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    PyObject *module_dict = PyModule_GetDict( module_urllib3$util$connection );
    ...
    tmp_assign_source_2 = const_str_digest_e3950db8186be59462f7236c420b872d;
    ...
    UPDATE_STRING_DICT0( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain___package__, tmp_assign_source_4 );
    tmp_assign_source_5 = PyObject_GetAttrString(PyImport_ImportModule("__future__"), "absolute_import");
    UPDATE_STRING_DICT0( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain_absolute_import, tmp_assign_source_5 );
    // Frame without reuse.
    frame_module = MAKE_MODULE_FRAME( codeobj_96074cf9034703e42da64ce351d3af5e, module_urllib3$util$connection );
    ...
    // Framed code:
    tmp_import_globals_1 = ((PyModuleObject *)module_urllib3$util$connection)->md_dict;
    ...
    UPDATE_STRING_DICT1( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain_socket, tmp_assign_source_6 );
    // Tried code:
    tmp_import_globals_2 = ((PyModuleObject *)module_urllib3$util$connection)->md_dict;
    ...
    UPDATE_STRING_DICT1( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain_poll, tmp_assign_source_7 );
    tmp_import_globals_3 = ((PyModuleObject *)module_urllib3$util$connection)->md_dict;
    frame_module->f_lineno = 4;
    ...
    UPDATE_STRING_DICT1( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain_POLLIN, tmp_assign_source_8 );
    goto try_end_1;
    // Exception handler code:
    try_except_handler_1:;
    exception_keeper_type_1 = exception_type;
    ...
    UPDATE_STRING_DICT0( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain_poll, tmp_assign_source_9 );
    // Tried code:
    tmp_import_globals_4 = ((PyModuleObject *)module_urllib3$util$connection)->md_dict;
    ...
    UPDATE_STRING_DICT1( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain_select, tmp_assign_source_10 );
    goto try_end_2;
    // Exception handler code:
    try_except_handler_3:;
    exception_keeper_type_2 = exception_type;
    ...
    UPDATE_STRING_DICT0( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain_select, tmp_assign_source_11 );
    goto branch_end_2;
    branch_no_2:;
    RERAISE_EXCEPTION( &exception_type, &exception_value, &exception_tb );
    ...
    goto try_end_2;
    // exception handler codes exits in all cases
    NUITKA_CANNOT_GET_HERE( urllib3$util$connection );
    ...
    // End of try:
    try_end_1:;
    tmp_assign_source_12 = MAKE_FUNCTION_function_1_is_connection_dropped_of_urllib3$util$connection(  );
    UPDATE_STRING_DICT1( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain_is_connection_dropped, tmp_assign_source_12 );
    ...
    tmp_assign_source_13 = MAKE_FUNCTION_function_2_create_connection_of_urllib3$util$connection( tmp_defaults_1 );
    UPDATE_STRING_DICT1( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain_create_connection, tmp_assign_source_13 );
    ...
    frame_no_exception_1:;
    tmp_assign_source_14 = MAKE_FUNCTION_function_3__set_socket_options_of_urllib3$util$connection(  );
    UPDATE_STRING_DICT1( moduledict_urllib3$util$connection, (Nuitka_StringObject *)const_str_plain__set_socket_options, tmp_assign_source_14 );
